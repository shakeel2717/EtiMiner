...
<body class="dark theme-color-default">
    ...
    <aside class="sidebar sidebar-base sidebar-default navs-rounded-all sidebar-dark" data-toggle="main-sidebar" data-sidebar="responsive">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="index.html" class="navbar-brand">
                <div class="logo-main">
                    <div class="logo-normal">
                        <img src="{{ asset('assets/brand/favi-dark.svg') }}" alt="Logo" width="20">
                    </div>
                    <div class="logo-mini">
                        <img src="{{ asset('assets/brand/favi-dark.svg') }}" alt="Logo">
                    </div>
                </div>
                <!--logo End-->
    ...
    <main class="main-content">
                                ...
                                <ul class="iq-nav-menu list-unstyled">
                                    <li class="nav-item ">
                                        <a class="nav-link menu-arrow justify-content-start active" data-bs-toggle="collapse" href="#homeData" role="button" aria-expanded="false" aria-controls="homeData">
                                            ...
                                            <span class="nav-text ms-2">Add Fund</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="content-inner container-fluid pb-0" id="page_layout">
            <form action="{{ route('logout') }}" method="POST">
                ...
                <button type="submit">lgoou</button>
            </form>
        </div>
        ...
        <footer class="footer">
            <div class="footer-body">
                ...
                <div class="right-panel">
                    <span>© {{ date("Y") }} Copyright: {{ env('APP_NAME') }}</span>.
                </div>
            </div>
        </footer>
        <!-- Footer Section End -->
